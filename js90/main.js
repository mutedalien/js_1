...
// ЕЩЕ МАССИВЫ
// задача: умножить каждый элемент массива на два и вывести результат

let m = [7, 3, 21]; //  исходный массив

function t1() {
    let p = [];     //  создаем массив, для хранения результата
    
    for (let i = 0; i < m.length; i++) {    //  в цикле перебираем каждый элемент массива m
        p[i] = m[i] * 2;                    //  умножаем его на два и сохраняем в массив p
    }
    console.log(p);     //  выводим результат в консоль
